...
Differential Privacy (DP) is a formal definition of privacy, meaning that DP methods meet certain mathematical properties and guarantees. With DP, it is possible to quantify the worst-case disclosure risk of a data release using a "privacy-loss budget." The privacy-loss budget is qunatified with parameters like $\epsilon$ and $\delta$. 

...
bind_cols(
  ...
  facet_wrap(~variable) +
  labs(
    title = "Low Opt-In Modestly Improves Proportion Estimates",
...
bind_cols(
  ...
  scale_y_continuous(limits = c(NA, 1000)) +  
  labs(
    title = "Low Opt-In Rates Improve the 2-Dimensional Marginal Distributions",
    subtitle = "Score from Holdout Data in Red",
    x = "Opt-In Rate",
    y = "2-Marginal Score"
  ) +  
...
bind_cols(
  ...
  labs(
    title = "No Synthesis Demonstrates High Membership Inference Risks",
    x = "Opt-In Rate",

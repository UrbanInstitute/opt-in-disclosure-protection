...
syntheses <- list.files(here::here("data", "results", "acs"), full.names = TRUE)[c(-1, -2)]
...
bind_cols(
  ...
  facet_wrap(~opt_in) +
  labs(
    title = "Low Opt-In Dramatically Improves the Distribution of Wage and Salary Income",
    x = "Percentile",
    y = "Proportion Error"
  ) +
  scatter_grid()
